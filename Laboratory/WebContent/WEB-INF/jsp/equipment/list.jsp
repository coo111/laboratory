...
<div class="page-content clearfix">
    <div id="Member_Ratings">
        <div class="d_Confirm_Order_style">
            ...
            <div class="search_style">
                <ul class="search_content clearfix">
                    <li><label class="l_f">设备型号</label><input name="xh" type="text" value="${bean.xh}" class="text_add"  style=" width:200px"/></li>
       ...
       <span class="l_f">
        <a href="javascript:ovid()" id="member_add" class="btn btn-warning"><i class="icon-plus"></i>添加设备</a>
       </span>
            </div>
...
<div class="add_menber" id="add_menber_style" style="display:none">
    <ul>
        <li><label class="label_name" style="width: 130px">设备型号：</label>
            <span class="add_name">
                <input value="" name="xh" type="text" id="设备型号" class="text_add"/>
            </span>
        </li>
        <li>
        ...
        <li class="adderss"><label class="label_name" style="width: 130px">设备用途说明：</label>
            <span class="add_name">
                <input name="bz" type="text" id="设备备注" class="text_add" style=" width:350px"/>
            </span>
        </li>
    </ul>
</div>
