                ...
                <ul class="nav nav-list" id="nav_list">
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span
                        ...
                        <ul class="submenu">
                            ...
                            <li class="home">
                                <a href="javascript:void(0)" name="laboratory_list.do" title="实验室列表" class="iframeurl">
                                    <i class="icon-double-angle-right"></i>实验室管理</a>
                            </li>
                            </c:if>
                            <li class="home">
                        ...
                        <li><a href="#" class="dropdown-toggle"><i class="icon-cogs"></i><span
                                                    class="menu-text"> 设备管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="equipment_list.do" title="技术参数管理"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>技术参数管理</a></li>
                            <li class="home"><a href="javascript:void(0)" name="equipment_dataList.do" title="运行数据管理"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>运行数据管理</a></li>
                            <li class="home"><a href="javascript:void(0)" name="equipment_dataList2.do" title="电子文档管理"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>电子文档管理</a></li>
                        </ul>
                    </li>
                         </c:if>
<c:if test="${role == 'admin'}">
